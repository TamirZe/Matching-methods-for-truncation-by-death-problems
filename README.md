...
One example script is ???.R file, which contains one set of arguments, the first row of argument_mat, for $k=5$, $(\pi_{as} = 0.5$, and low $\pi_{pro})$, as in Table 2 (Scenario A) of the main text.
