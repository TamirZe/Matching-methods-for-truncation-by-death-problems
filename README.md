...
The script is ???.R file contains one set of arguments, the first row of argument_mat, for $k=5$, $(\pi_{as} = 0.5$, and low $\pi_{pro})$. It can be ran to obtain the results of Table 2 (Scenario A) of the main text.
