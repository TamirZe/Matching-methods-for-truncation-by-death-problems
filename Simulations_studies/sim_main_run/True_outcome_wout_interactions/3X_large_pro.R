...
#print(ifelse(identical(betas_GPI[-1,1], betas_GPI[-1,2]), "True_outcome_wout_interactions", "True_outcome_with_interactions"))
###############################################################################################
...
if(job_id >=0 & job_id <=3){
  ...
  #ifelse(identical(betas_GPI[-1,1], betas_GPI[-1,2]), "True_outcome_wout_interactions", "True_outcome_with_interactions")
