...
#extract_pis_lst = extract_pis_from_scenarios(nn=1000000, xi=xi, misspec_PS=0, two_log_models=TRUE); mat_pis_per_gamma = extract_pis_lst$mat_pis
#mat_pis_per_gamma
###############################################################################################
