...
# no misspec (misspec_PS=0) ####
out_with_inter_correct_out_correct_PS_path = 
  "C:/Users/tamir/Documents/A matching framework for truncation by death problems/Data_cluster/True_outcome_with_interactions/Correct_spec_outcome/Correct_spec_PS/"

# 3X
small_pro_path3 = paste0(out_with_inter_correct_out_correct_PS_path, "3X/Large_pi_pro/", "xi = ", xi, "/")
large_pro_path3 = paste0(out_with_inter_correct_out_correct_PS_path, "3X/Low_pi_pro/", "xi = ", xi, "/")
# 5X
small_pro_path5 = paste0(out_with_inter_correct_out_correct_PS_path, "5X/Large_pi_pro/", "xi = ", xi, "/")
large_pro_path5 = paste0(out_with_inter_correct_out_correct_PS_path, "5X/Low_pi_pro/", "xi = ", xi, "/")
# 10X
small_pro_path10 = paste0(out_with_inter_correct_out_correct_PS_path, "10X/Large_pi_pro/", "xi = ", xi, "/")
large_pro_path10 = paste0(out_with_inter_correct_out_correct_PS_path, "10X/Low_pi_pro/", "xi = ", xi, "/")

# Func Form misspec (misspec_PS=2) ####
out_with_inter_correct_out_mis_PS_path = 
  "C:/Users/tamir/Documents/A matching framework for truncation by death problems/Data_cluster/True_outcome_with_interactions/Correct_spec_outcome/Mis_spec_PS/"

# 3X
small_pro_path3 = paste0(out_with_inter_correct_out_mis_PS_path, "3X/Large_pi_pro/", "xi = ", xi, "/")
large_pro_path3 = paste0(out_with_inter_correct_out_mis_PS_path, "3X/Low_pi_pro/", "xi = ", xi, "/")
# 5X
small_pro_path5 = paste0(out_with_inter_correct_out_mis_PS_path, "5X/Large_pi_pro/", "xi = ", xi, "/")
large_pro_path5 = paste0(out_with_inter_correct_out_mis_PS_path, "5X/Low_pi_pro/", "xi = ", xi, "/")
# 10X
small_pro_path10 = paste0(out_with_inter_correct_out_mis_PS_path, "10X/Large_pi_pro/", "xi = ", xi, "/")
large_pro_path10 = paste0(out_with_inter_correct_out_mis_PS_path, "10X/Low_pi_pro/", "xi = ", xi, "/")
####################################################################################################################################################################################################