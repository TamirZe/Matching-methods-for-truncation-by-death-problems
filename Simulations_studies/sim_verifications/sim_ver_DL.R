...
plot(dfrm_A1_S1$W_1_as_true, res, cex.main=0.7, main = paste0("W_1_as, res:est-true", " O(1,1)", ". set", k, ", as: ", paste(mat_gamma[k,c(1,2)], collapse = ","), ", pro: " , paste(mat_gamma[k,c(dim_x+1,dim_x+2)], collapse = ",")))
mean(res); mean(abs(res))
# principal scores
...
# weights
hist(dfrm_A1_S1$W_1_as_true, xlim=c(0,1.3), col="blue", main = paste0("W_1_as, O(1,1)", ". blue-true, green-est"), breaks = 30)
...
for (j in 1:length(g_options)){
  ...
  abline(a=0,b=1, lwd=3)
  hist(datfrm_g$W_1_as_true, xlim=c(0,1.3), col="blue", main = paste0("W_1_as, ", "g=", g_options[j], ". blue-true, green-est"), breaks = 30)
  ...
  #hist(datfrm_g$O11_posterior_ratio_true, xlim=c(0,1.3), col="blue", main = "O11_posterior_ratio, blue-true, green-est")
  ...
  # hist(datfrm_g$prob_as, xlim=c(0,1.3), col="blue", main = "prob_as, blue-true, green-est"); hist(datfrm_g$EMest_p_as, add=T, col=rgb(0, 1, 0, 0.5) )
  ...
  # hist(datfrm_g$prob_pro, xlim=c(0,1.3), col="blue",  main = "prob_pro, blue-true, green-est"); hist(datfrm_g$EMest_p_pro, add=T, col=rgb(0, 1, 0, 0.5) )
  ...
  # hist(datfrm_g$prob_ns, xlim=c(0,1.3), col="blue",  main = "prob_ns, blue-true, green-est"); hist(datfrm_g$EMest_p_ns, add=T, col=rgb(0, 1, 0, 0.5) )
}
#dev.off()
#################################################################################################################
