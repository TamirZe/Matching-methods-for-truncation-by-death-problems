...
correct_spec_PS = FALSE # no misspec (misspec_PS=0) # Func Form misspec (misspec_PS=2)
...
large_pro_path3 = paste0(correct_spec_outcome_path, "3X/Low_pi_pro/", "xi = ", xi, "/")
# 5X
small_pro_path5 = paste0(correct_spec_outcome_path, "5X/Large_pi_pro/", "xi = ", xi, "/")
large_pro_path5 = paste0(correct_spec_outcome_path, "5X/Low_pi_pro/", "xi = ", xi, "/")
# 10X
small_pro_path10 = paste0(correct_spec_outcome_path, "10X/Large_pi_pro/", "xi = ", xi, "/")
large_pro_path10 = paste0(correct_spec_outcome_path, "10X/Low_pi_pro/", "xi = ", xi, "/")
####################################################################################################################################################################################################