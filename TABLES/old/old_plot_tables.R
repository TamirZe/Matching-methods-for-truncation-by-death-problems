...
add_bias_tables = function(lst, estimators_vec=NULL, N_obs, num_of_x,
  ...
  for(i in 1:length(lst)){
    ...
    if(!is.null(estimators_vec)){
      ...
      #TODO orde the cpls as we want them
    }
    new_lst[[i]] = tmp
  }
...
# no misspec # Unobserved # Func Form/mis2 ff 5X large pro -3 3; Func Form/mis2 ff 5X small pro -3 3
# 3X
small_pro_path3 = "C:/Users/tamir/Documents/R projects/AA Thesis Causal inference/Simulations principal score estimation/R data/ding EM code/model with interaction/no misspec/small pro/3X/"
large_pro_path3 = "C:/Users/tamir/Documents/R projects/AA Thesis Causal inference/Simulations principal score estimation/R data/ding EM code/model with interaction/no misspec/large pro/3X/"
# 5X
small_pro_path5 = "C:/Users/tamir/Documents/R projects/AA Thesis Causal inference/Simulations principal score estimation/R data/ding EM code/model with interaction/no misspec/small pro/5X/"
large_pro_path5 = "C:/Users/tamir/Documents/R projects/AA Thesis Causal inference/Simulations principal score estimation/R data/ding EM code/model with interaction/no misspec/large pro/5X/"
# 10X
small_pro_path10 = "C:/Users/tamir/Documents/R projects/AA Thesis Causal inference/Simulations principal score estimation/R data/ding EM code/model with interaction/no misspec/small pro/5X/"
large_pro_path10 = "C:/Users/tamir/Documents/R projects/AA Thesis Causal inference/Simulations principal score estimation/R data/ding EM code/model with interaction/no misspec/large pro/5X/"
...
# TODO just for ilustration, just use all and wout 0,0 as datasets with different k
...
small_pro$protected = "Low protected prop"
...
large_pro$protected = "High protected prop"

small_large_pro = rbind(small_pro, large_pro)
small_large_pro$Pi_as = mgsub(small_large_pro$Scenario, c("A", "B", "C"),
                              c("pi as = 0.25", "pi as = 0.5", "pi as = 0.75"))
...
xlim("3", "5", "10") +
labs(title="Bias of different estimators, N = 2000", y="Bias", x="k", caption="N = 2000") +
...
facet_grid(protected ~ Pi_as) +
  ...
  labs(title="Mahalanobis and PS caliper, N = 2000", y="Bias", x="k", caption="N = 2000") +
...
tables_small_pro10 = get(load(paste0(small_pro_path5, "final_tables_crude.RData"))) #tables_small_pro = get(tables_small_pro)
tables_large_pro10 = get(load(paste0(large_pro_path5, "final_tables_crude.RData"))) #tables_large_pro = get(tables_large_pro)
...
plot_PS <- ggplot(small_large_pro, aes(x=k, y=Bias)) +
  geom_point(aes(col = EstCombi, size = Emp.SD)) + 
  xlim("3", "5", "10") +
  labs(title="PS crude, N = 2000", y="Bias", x="k", caption="N = 2000") +
  labs(colour="Estimator", size = "Emp SD") + 
  scale_color_discrete(name="Estimator")  +
  scale_size_continuous(name = "Emp SD",range = c(3, 8)) +
  guides(colour = guide_legend(order = 1, override.aes = list(size=7))) + 
