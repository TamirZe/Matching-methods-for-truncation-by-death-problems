...
scen = 1 # scen =1  (pi as = 0.5) # scen = 2 (pi as = 0.75)
#############################################################################################
...
AX_interactions = arguments_mat[1, "AX_interactions"]
# CPSR parameter
xi = arguments_mat[1, "xi"]
xi_assm = arguments_mat[1, "xi_assm"]
misspec_PS = arguments_mat[1, "misspec_PS"]
misspec_outcome = arguments_mat[1, "misspec_outcome"]
print(paste0('xi=', xi, ", xi_assm=", xi_assm))
print(arguments_mat[1, ])
